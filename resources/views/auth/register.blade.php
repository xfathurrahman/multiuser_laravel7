                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row py-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @empty
                                <option value="" disabled>Create Client First.</option>
                                @endforelse
                                </select>
                                @error('client_id')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row py-3">
                            <label for="state" class="col-md-4 col-form-label text-md-right">{{ __('State Name') }} *</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row  py-3">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city') }}" maxlenth="15" required autocomplete="city" autofocus>
