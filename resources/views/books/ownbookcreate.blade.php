    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form id="ownbookform" method="POST" action="{{ route('ownclientbookcreate') }}">
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="delivery_date" type="date" class="form-control @error('delivery_date') is-invalid @enderror" name="delivery_date" value="{{ old('delivery_date') }}" required autocomplete="delivery_date" autofocus>
...
$(".btn-submit").click(function(e) {
    ...
    $.ajax({
        type: "POST",
        url: "{{ url('ownclientbookcreate') }}",
        data: formdata,
        success: function(res){
            if(res.success===true){
                alert(res.message);
                window.location.href = "{{ route('ownclientbooklist') }}";
            }else{
