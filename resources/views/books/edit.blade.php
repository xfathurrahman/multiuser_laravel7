  ...
  <div class="row">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">{{ __('Book Editing') }}</h3>
        ...
        <div class="card-body">
            <form id="editbookform" method="POST" action="{{ route('book.store') }}">
            @csrf
            <input type="hidden" name="_method" value="PUT">
            <input type="hidden" name="book_primary_id" id="book_primary_id" value={{explode("/", $data)[4]}}>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="isbn_number" type="text" class="form-control @error('isbn_number') is-invalid @enderror" name="isbn_number" value="{{ $book->isbn_number }}" required autocomplete="isbn_number" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="received_date" type="date" class="form-control @error('received_date') is-invalid @enderror" name="received_date" value="{{ $book->received_date }}" required autocomplete="received_date" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="del_date" type="date" class="form-control @error('del_date') is-invalid @enderror" 
                    name="delivery_date" 
                    value="{{ $book->delivery_date }}" required autocomplete="del_date" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="author_first_name" type="text" class="form-control @error('author_first_name') is-invalid @enderror" name="author_first_name" value="{{ $book->author_first_name }}" maxlenth="200" required autocomplete="address" autofocus>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input type="text" id="author_last_name" class="form-control @error('author_last_name') is-invalid @enderror" name="author_last_name" value="{{ $book->author_last_name }}" required autocomplete="author_last_name" autofocus />
